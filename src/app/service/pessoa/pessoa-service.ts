...
export class PessoaService {
    ...
    cadastrar(pessoa: Pessoa): Observable<Pessoa> {
        const urlApi = `https://6aa31e7be7ae868cdf7a9be8.mockapi.io/pessoa/`
    ...
    listarPessoa(pessoaId: number): Observable<Pessoa>{
        const urlApi = `https://6aa31e7be7ae868cdf7a9be8.mockapi.io/pessoa/${pessoaId}`

        return this.http.get<Pessoa>(urlApi)
    }

    excluirPessoa(pessoa: Pessoa): Observable<Pessoa>{
        const urlApi = `https://6aa31e7be7ae868cdf7a9be8.mockapi.io/pessoa/${pessoa.idpessoa}`
